...
// 读取远程文件到本地(也可以读视频)
client
  .createReadStream("/test/1.txt").pipe(fs.createWriteStream("3.txt"));

client.createReadStream("/test/1.mp4").pipe(fs.createWriteStream("1.mp4"));
// 删除文件
...
await client.getFileContents("/test/1.txt", {
  onDownloadProgress: (progressEvent) => {
    console.log(progressEvent.loaded + "/" + progressEvent.total)   // {   //     total: 12345600,   //     loaded: 54023   // } }
...
[{
  filename: "/my-file.txt", basename: "my-file.txt", lastmod: "Mon, 10 Oct 2018 23:24:11 GMT", size: 371, type: "file"
}]
