...
def get_file_name(root_dir):
    ...
    for parent, _, file_names in os.walk(root_dir):
        for full_name in file_names:
            # 完整路径
            # file_path = os.path.join(parent, full_name)
            print("## " + full_name.replace(".md", "") + "\n")


ROOT_DIR = r"F:\\obsidian_notes\\SpeedTree"
ROOT_DIR2 = r"H:\\Scripting\\Vue Projects\\docs_yuelili_com\\docs\\zh\\Speed Tree"
vuepress_generate_file_doc(ROOT_DIR2)
