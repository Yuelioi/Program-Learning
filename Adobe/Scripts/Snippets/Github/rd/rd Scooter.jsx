...
//						shiftBtn: Button { text:'" + rd_Scooter_localize(rd_ScooterData.strShift) + "' }, \
	...
	// 
	// Description:
	// This callback function assures that the entered value is a positive number.
	// 这个回调函数保证了输入的数值是一个正数。
	// 
	// Parameters:
	// None.
	...
	function rd_Scooter_scootLayerMarkers(layer, offset)
	{
		...
		// Loop through the layer's markers in the direction such that new markers will not affect the indices of existing markers
		// 循环该层的标记，新的标记不会影响到现有标记的index。
