/**
 * 名称：Mask_Selection_Helper .jsx
 * 功能：选择大量蒙版，并一次性更改蒙版的属性（如羽毛、不透明度、模式等——但不是蒙版形状本身*）？此脚本（调色板窗口）可能会有所帮助。您可以选择合成中的所有蒙版，或名称与字符串匹配的所有蒙版，或按索引选择。
[* 您可以通过这种方式为多个蒙版形状设置动画，但每个（关键）帧只输入一个值，因此对于大多数应用程序来说并不实用。]
 * 
 * 油管：http://www.crgreen.com/aescripts/
 * 日期：
 * 源码（中文）：https://www.yuelili.com/
 * 源码（英文）：http://www.crgreen.com/aescripts/actual_scripts/Mask_Selection_Helper.jsx
 * 其他：
 */
