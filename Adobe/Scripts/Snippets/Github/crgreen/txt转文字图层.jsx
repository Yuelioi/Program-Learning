/**
 * 名称：crg_Text_from_File .jsx
 * 功能：将文本文件作为文本图层导入。该脚本基于此，但它更进一步，为您提供了更多选项，例如行间距，或仅创建一个包含所有文本的文本层。
 * 油管：http://www.crgreen.com/aescripts/
 * 日期：2013.2.22
 * 源码（中文）：https://www.yuelili.com/
 * 源码（英文）：http://www.crgreen.com/aescripts/actual_scripts/crg_Text_from_File.jsx
 * 其他：
 */
