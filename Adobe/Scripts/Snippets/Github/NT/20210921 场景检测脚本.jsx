/**
 * 名称：场景检测
 * 功能：选择一个图层（比如XX.mp4）运行该脚本，则会自动切割图层，时间大概1比1 请耐心等待
 * 油管：https://www.youtube.com/watch?v=tgQlbmmR2G4&t=14s&ab_channel=NTProductions
 * 日期：
 * 源码（中文）：https://www.yuelili.com/
 * 源码（英文）：https://github.com/NTProductions/scene-detection-script/blob/main/Scene%20Detection%20Script.jsx
 */
