 ...
 * @param curPropGroup : the property group you search through
 * @param propName : property matchName you want to get
 * @returns : PropertyGroup | Property | null
 */
export const search_prop = function (curPropGroup: PropertyGroup, propName: string): PropertyGroup | Property | null {
