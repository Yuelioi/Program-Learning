/**
 * 名称：Connect_Point_to_Mask_Vertex .jsx
 * 功能：通过将顶点“链接”到任何二维点属性（如位置、跟踪点附加点、“点”表达式控件等），允许单个蒙版顶点的动画。
...
// Connect Vertex to Point (the vertex linker)
// An After Effects (CS3) script
// to aid in the animating of individual mask vertices
// by linking them to other (point) properties.
// version 2.0 (created to work with AE CS3 -- I also changed the way it goes about looking at selected layers and properties
// by CR Green
...
/*
Note:
This is meant to work with a mask layer of the same size of the comp,  and that layer should have its 
default geometric values (size [scale], rotation, position, etc.).
...
function moveGuideToV() {
	...
	var myProperty = theMask.property("ADBE Mask Shape");
