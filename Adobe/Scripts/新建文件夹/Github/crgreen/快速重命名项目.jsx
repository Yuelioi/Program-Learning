/**
 * 名称：Project_Items_Renamer .jsx
 * 功能：快速批量重命名项目中任何（可重命名）类型的选定项目。
 * 油管：http://www.crgreen.com/aescripts/
 * 日期：2013.1.12
 * 源码（中文）：https://www.yuelili.com/
 * 源码（英文）：http://www.crgreen.com/aescripts/actual_scripts/Project_Items_Renamer.jsx
 * 其他：version 1.9 brings code up-to-date to work as dockable, if desired, and makes window more compact
 */
