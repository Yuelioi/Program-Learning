/**
 * 名称：MakeCube-CRGmod .jsx
 * 功能：很久以前，一个叫 Nicholas White 的人创建了一个脚本来构建一个盒子，并将其发布 到aenhancers.com。最近决定修改一下。我添加了一个 UI（接受公式！哦！）并做了一些简单但重要的调整。
 * 
 * 油管：http://www.crgreen.com/aescripts/
 * 日期：
 * 源码（中文）：https://www.yuelili.com/
 * 源码（英文）：http://www.crgreen.com/aescripts/actual_scripts/MakeCube-CRGmod.jsx
 * 其他：
 */
